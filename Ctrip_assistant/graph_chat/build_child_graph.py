...
from Live_Streaming_practice.Ctrip_assistant.graph_chat.agent_assistant import update_flight_runnable, \
    update_flight_sensitive_tools, update_flight_safe_tools, book_excursion_runnable, book_excursion_safe_tools, \
    book_excursion_sensitive_tools, book_hotel_safe_tools, book_hotel_sensitive_tools, book_hotel_runnable, \
    book_car_rental_safe_tools, book_car_rental_sensitive_tools, book_car_rental_runnable
from Live_Streaming_practice.Ctrip_assistant.graph_chat.assistant import CtripAssistant
from Live_Streaming_practice.Ctrip_assistant.graph_chat.base_data_model import CompleteOrEscalate
from Live_Streaming_practice.Ctrip_assistant.graph_chat.entry_node import create_entry_node
from Live_Streaming_practice.Ctrip_assistant.tools.tools_handler import create_tool_node_with_fallback


# flight booking assistant, chile graph
def builder_flight_graph(builder: StateGraph) -> StateGraph:
    """构建 航班预订助理的子工作流图"""
