...
db = "../travel_new.sqlite"  # name of the database


@tool
def fetch_user_flight_information(config: RunnableConfig) -> List[Dict]:
    """
    This function fetches a passenger's all flight information and the seating information
    from the database with the passenger's ID
    Return: a dictionary with every flight ticket's details, info of related flights, and seating inforation.
    """
    configuration = config.get("configurable", {})
    passenger_id = configuration.get("passenger_id", None)
    if not passenger_id:
        raise ValueError("Passenger ID is not found.")
